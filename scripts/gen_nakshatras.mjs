...
const WHATIS = {
  ...
  "purva-phalguni": "Purva Phalguni is the star of rest and delight. Its deity is Bhaga, god of fortune and marital happiness, and its symbol is the front legs of a bed or a hammock — leisure, romance, the enjoyment of what has been earned. There is creativity and easy charm in natives here. Venus, fittingly, rules it.",
  ...
  hasta: "Hasta means 'the hand', and the whole star is about what skilled hands can do — craft, dexterity, healing touch, things made well. Its deity is Savitar, the Sun in its creative, life-stirring aspect, the one who blesses good work. Natives often have a knack and a deftness others lack. The Moon rules it.",
  chitra: "Chitra is the bright jewel of the sky — its single star is the brilliant Spica. The name means 'the dazzling one', and its deity is Tvashtar, the celestial architect who fashions beautiful forms. This is a star of design, artistry and striking appearance. Mars, the maker and destroyer, is its lord.",
  swati: "Swati is the young shoot bending in the wind without breaking. Its deity is Vayu, the wind itself, and its symbol is a blade of grass or a sword swaying — independence, flexibility, the strength that comes from yielding. Natives prize their freedom and self-reliance. Rahu, the boundary-crosser, rules it.",
  vishakha: "Vishakha is the star of focused ambition — a forked branch, two paths converging on one goal. Its deities are Indra and Agni together, raw power joined to transforming fire. It drives the determined pursuit of an aim, sometimes single-mindedly. Jupiter, planet of purpose and expansion, is its lord.",
  ...
  jyeshtha: "Jyeshtha means 'the eldest' — the senior, the one who has earned authority and carries its burden. Its deity is Indra, king of the gods, and its symbol is a protective amulet or umbrella. It speaks of seniority, responsibility and a certain hard-won eminence. Mercury is its lord.",
  ...
  "purva-ashadha": "Purva Ashadha is 'the invincible' — the early victory, before any setback. Its deity is Apas, the cosmic waters, and its symbol is a winnowing fan or tusk. It carries unstoppable enthusiasm, the confidence of a tide coming in. Venus, planet of charm and persuasion, is its lord.",
  "uttara-ashadha": "Uttara Ashadha is the lasting victory, the one that holds. Its deities are the Vishvadevas, the universal gods, and its symbol is an elephant's tusk — strength, integrity, triumph built to endure. Natives are often principled and patient, winning slowly and keeping it. The Sun rules it.",
  shravana: "Shravana is the star of listening. Its deity is Vishnu, and its symbol is an ear, or three footprints — the receptive attention through which knowledge and tradition are passed down. It favours learning, scholarship and the careful keeping of what is heard. The Moon, ruler of the receptive mind, is its lord.",
  dhanishta: "Dhanishta beats like a drum. Its deities are the eight Vasus, gods of abundance and the elements, and its symbol is a musical drum or flute — rhythm, wealth, fame, the pulse that moves a crowd. Natives often have a feel for music, timing and prosperity. Mars, the energetic lord, governs it.",
  ...
  "purva-bhadrapada": "Purva Bhadrapada carries a fierce, otherworldly fire. Its deity is Aja Ekapada, the one-footed serpent of the depths, and its symbol is a two-faced figure or a funeral cot — intensity, idealism, the readiness to burn for a cause. It looks past the comfortable toward the absolute. Jupiter is its lord.",
  ...
  revati: "Revati closes the circle. The last of the 27, its deity is Pushan, the shepherd who guides travellers and souls safely home, and its symbol is a fish swimming or a drum marking time. It is a star of nourishment, safe journeys and gentle endings that become beginnings. Mercury is its lord.",
};
